...
result = income - outlay
if result > 0:
    print(f"Финансовый результат - прибыль. Её величина: {result}")
    print("Рентабельность выручки = " + str(result / income))
    staff = int(input("Введите численность сотрудников фирмы: "))
    print("Прибыль фирмы в расчете на одного сотрудника = " + str(result / staff))
else:
    result *= -1
    print(f"Финансовый результат - убытки. Их величина: {result}")
